...
// LaunchTemplate_ConnectionTrackingSpecification AWS CloudFormation Resource (AWS::EC2::LaunchTemplate.ConnectionTrackingSpecification)
...
func (r *LaunchTemplate_ConnectionTrackingSpecification) AWSCloudFormationType() string {
	return "AWS::EC2::LaunchTemplate.ConnectionTrackingSpecification"
}
