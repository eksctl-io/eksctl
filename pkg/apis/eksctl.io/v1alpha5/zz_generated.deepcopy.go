...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UnsupportedFeatureError) DeepCopyInto(out *UnsupportedFeatureError) {
	*out = *in
	if in.Err != nil {
		out.Err = in.Err.DeepCopyerror()
	}
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UnsupportedFeatureError.
func (in *UnsupportedFeatureError) DeepCopy() *UnsupportedFeatureError {
	if in == nil {
		return nil
	}
	out := new(UnsupportedFeatureError)
	in.DeepCopyInto(out)
	return out
}
