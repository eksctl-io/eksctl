...
type Bucket_PartitionedPrefix struct {
	...
	PartitionDateSource *types.Value `json:"PartitionDateSource,omitempty"`
...
func (r *Bucket_PartitionedPrefix) AWSCloudFormationType() string {
	return "AWS::S3::Bucket.PartitionedPrefix"
}
