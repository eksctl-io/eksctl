...
type AWSElasticLoadBalancingV2ListenerRule_AuthenticateCognitoConfig struct {
	...
	UserPoolArn *Value `json:"UserPoolArn,omitempty"`
	...
	UserPoolClientId *Value `json:"UserPoolClientId,omitempty"`
	...
	UserPoolDomain *Value `json:"UserPoolDomain,omitempty"`
}
...
func (r *AWSElasticLoadBalancingV2ListenerRule_AuthenticateCognitoConfig) MarshalJSON() ([]byte, error) {
