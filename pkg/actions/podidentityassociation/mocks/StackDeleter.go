...
// GetIAMServiceAccounts provides a mock function with given fields: ctx, name, namespace
func (_m *StackDeleter) GetIAMServiceAccounts(ctx context.Context, name string, namespace string) ([]*v1alpha5.ClusterIAMServiceAccount, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) ([]*v1alpha5.ClusterIAMServiceAccount, error)); ok {
		return rf(ctx, name, namespace)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) []*v1alpha5.ClusterIAMServiceAccount); ok {
...
//   - name string
//   - namespace string
func (_e *StackDeleter_Expecter) GetIAMServiceAccounts(ctx interface{}, name interface{}, namespace interface{}) *StackDeleter_GetIAMServiceAccounts_Call {
	return &StackDeleter_GetIAMServiceAccounts_Call{Call: _e.mock.On("GetIAMServiceAccounts", ctx, name, namespace)}
}

func (_c *StackDeleter_GetIAMServiceAccounts_Call) Run(run func(ctx context.Context, name string, namespace string)) *StackDeleter_GetIAMServiceAccounts_Call {
	_c.Call.Run(func(args mock.Arguments) {
