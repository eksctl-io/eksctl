...
// AccessGrant AWS CloudFormation Resource (AWS::S3::AccessGrant)
...
type AccessGrant struct {
	...
	// AccessGrantsLocationId AWS CloudFormation Property
	// Required: true
	...
	AccessGrantsLocationId *types.Value `json:"AccessGrantsLocationId,omitempty"`
	...
	// Grantee AWS CloudFormation Property
	// Required: true
	...
	S3PrefixType *types.Value `json:"S3PrefixType,omitempty"`
...
func (r *AccessGrant) AWSCloudFormationType() string {
	return "AWS::S3::AccessGrant"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccessGrant) MarshalJSON() ([]byte, error) {
	type Properties AccessGrant
...
func (r *AccessGrant) UnmarshalJSON(b []byte) error {
	type Properties AccessGrant
	res := &struct {
		Type                string
		Properties          *Properties
