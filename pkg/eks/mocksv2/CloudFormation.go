...
func (_m *CloudFormation) DescribeEvents(ctx context.Context, params *cloudformation.DescribeEventsInput, optFns ...func(*cloudformation.Options)) (*cloudformation.DescribeEventsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// CloudFormation_DescribeEvents_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DescribeEvents'
type CloudFormation_DescribeEvents_Call struct {
	*mock.Call
}

// DescribeEvents is a helper method to define mock.On call
//   - ctx context.Context
//   - params *cloudformation.DescribeEventsInput
//   - optFns ...func(*cloudformation.Options)
func (_e *CloudFormation_Expecter) DescribeEvents(ctx interface{}, params interface{}, optFns ...interface{}) *CloudFormation_DescribeEvents_Call {
	return &CloudFormation_DescribeEvents_Call{Call: _e.mock.On("DescribeEvents",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *CloudFormation_DescribeEvents_Call) Run(run func(ctx context.Context, params *cloudformation.DescribeEventsInput, optFns ...func(*cloudformation.Options))) *CloudFormation_DescribeEvents_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*cloudformation.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*cloudformation.DescribeEventsInput), variadicArgs...)
	})
	return _c
}

func (_c *CloudFormation_DescribeEvents_Call) Return(_a0 *cloudformation.DescribeEventsOutput, _a1 error) *CloudFormation_DescribeEvents_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CloudFormation_DescribeEvents_Call) RunAndReturn(run func(context.Context, *cloudformation.DescribeEventsInput, ...func(*cloudformation.Options)) (*cloudformation.DescribeEventsOutput, error)) *CloudFormation_DescribeEvents_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *CloudFormation) GetHookResult(ctx context.Context, params *cloudformation.GetHookResultInput, optFns ...func(*cloudformation.Options)) (*cloudformation.GetHookResultOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// CloudFormation_GetHookResult_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetHookResult'
type CloudFormation_GetHookResult_Call struct {
	*mock.Call
}

// GetHookResult is a helper method to define mock.On call
//   - ctx context.Context
//   - params *cloudformation.GetHookResultInput
//   - optFns ...func(*cloudformation.Options)
func (_e *CloudFormation_Expecter) GetHookResult(ctx interface{}, params interface{}, optFns ...interface{}) *CloudFormation_GetHookResult_Call {
	return &CloudFormation_GetHookResult_Call{Call: _e.mock.On("GetHookResult",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *CloudFormation_GetHookResult_Call) Run(run func(ctx context.Context, params *cloudformation.GetHookResultInput, optFns ...func(*cloudformation.Options))) *CloudFormation_GetHookResult_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*cloudformation.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*cloudformation.GetHookResultInput), variadicArgs...)
	})
	return _c
}

func (_c *CloudFormation_GetHookResult_Call) Return(_a0 *cloudformation.GetHookResultOutput, _a1 error) *CloudFormation_GetHookResult_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CloudFormation_GetHookResult_Call) RunAndReturn(run func(context.Context, *cloudformation.GetHookResultInput, ...func(*cloudformation.Options)) (*cloudformation.GetHookResultOutput, error)) *CloudFormation_GetHookResult_Call {
	_c.Call.Return(run)
	return _c
}
