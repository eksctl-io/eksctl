...
func (r *TopicInlinePolicy) AWSCloudFormationType() string {
	return "AWS::SNS::TopicInlinePolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TopicInlinePolicy) MarshalJSON() ([]byte, error) {
	type Properties TopicInlinePolicy
...
func (r *TopicInlinePolicy) UnmarshalJSON(b []byte) error {
	type Properties TopicInlinePolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TopicInlinePolicy(*res.Properties)
	}
