...
// AccessGrantsInstance AWS CloudFormation Resource (AWS::S3::AccessGrantsInstance)
...
type AccessGrantsInstance struct {
	...
	// IdentityCenterArn AWS CloudFormation Property
	// Required: false
	...
	IdentityCenterArn *types.Value `json:"IdentityCenterArn,omitempty"`
...
func (r *AccessGrantsInstance) AWSCloudFormationType() string {
	return "AWS::S3::AccessGrantsInstance"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r AccessGrantsInstance) MarshalJSON() ([]byte, error) {
	type Properties AccessGrantsInstance
...
func (r *AccessGrantsInstance) UnmarshalJSON(b []byte) error {
	type Properties AccessGrantsInstance
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = AccessGrantsInstance(*res.Properties)
	}
