...
type AWSRAMResourceShare struct {
	...
	AllowExternalPrincipals *Value `json:"AllowExternalPrincipals,omitempty"`
	...
	Principals []*Value `json:"Principals,omitempty"`
	...
	ResourceArns []*Value `json:"ResourceArns,omitempty"`
