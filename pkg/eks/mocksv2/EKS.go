...
func (_m *EKS) DescribeInsightsRefresh(ctx context.Context, params *eks.DescribeInsightsRefreshInput, optFns ...func(*eks.Options)) (*eks.DescribeInsightsRefreshOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// EKS_DescribeInsightsRefresh_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'DescribeInsightsRefresh'
type EKS_DescribeInsightsRefresh_Call struct {
	*mock.Call
}

// DescribeInsightsRefresh is a helper method to define mock.On call
//   - ctx context.Context
//   - params *eks.DescribeInsightsRefreshInput
//   - optFns ...func(*eks.Options)
func (_e *EKS_Expecter) DescribeInsightsRefresh(ctx interface{}, params interface{}, optFns ...interface{}) *EKS_DescribeInsightsRefresh_Call {
	return &EKS_DescribeInsightsRefresh_Call{Call: _e.mock.On("DescribeInsightsRefresh",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *EKS_DescribeInsightsRefresh_Call) Run(run func(ctx context.Context, params *eks.DescribeInsightsRefreshInput, optFns ...func(*eks.Options))) *EKS_DescribeInsightsRefresh_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*eks.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*eks.DescribeInsightsRefreshInput), variadicArgs...)
	})
	return _c
}

func (_c *EKS_DescribeInsightsRefresh_Call) Return(_a0 *eks.DescribeInsightsRefreshOutput, _a1 error) *EKS_DescribeInsightsRefresh_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EKS_DescribeInsightsRefresh_Call) RunAndReturn(run func(context.Context, *eks.DescribeInsightsRefreshInput, ...func(*eks.Options)) (*eks.DescribeInsightsRefreshOutput, error)) *EKS_DescribeInsightsRefresh_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *EKS) StartInsightsRefresh(ctx context.Context, params *eks.StartInsightsRefreshInput, optFns ...func(*eks.Options)) (*eks.StartInsightsRefreshOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// EKS_StartInsightsRefresh_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StartInsightsRefresh'
type EKS_StartInsightsRefresh_Call struct {
	*mock.Call
}

// StartInsightsRefresh is a helper method to define mock.On call
//   - ctx context.Context
//   - params *eks.StartInsightsRefreshInput
//   - optFns ...func(*eks.Options)
func (_e *EKS_Expecter) StartInsightsRefresh(ctx interface{}, params interface{}, optFns ...interface{}) *EKS_StartInsightsRefresh_Call {
	return &EKS_StartInsightsRefresh_Call{Call: _e.mock.On("StartInsightsRefresh",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *EKS_StartInsightsRefresh_Call) Run(run func(ctx context.Context, params *eks.StartInsightsRefreshInput, optFns ...func(*eks.Options))) *EKS_StartInsightsRefresh_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*eks.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*eks.StartInsightsRefreshInput), variadicArgs...)
	})
	return _c
}

func (_c *EKS_StartInsightsRefresh_Call) Return(_a0 *eks.StartInsightsRefreshOutput, _a1 error) *EKS_StartInsightsRefresh_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *EKS_StartInsightsRefresh_Call) RunAndReturn(run func(context.Context, *eks.StartInsightsRefreshInput, ...func(*eks.Options)) (*eks.StartInsightsRefreshOutput, error)) *EKS_StartInsightsRefresh_Call {
	_c.Call.Return(run)
	return _c
}
