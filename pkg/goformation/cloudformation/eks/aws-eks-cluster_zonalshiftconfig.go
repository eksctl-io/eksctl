...
// Cluster_ZonalShiftConfig AWS CloudFormation Resource (AWS::EKS::Cluster.ZonalShiftConfig)
...
func (r *Cluster_ZonalShiftConfig) AWSCloudFormationType() string {
	return "AWS::EKS::Cluster.ZonalShiftConfig"
}
