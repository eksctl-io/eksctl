...
// TrustStoreRevocation AWS CloudFormation Resource (AWS::ElasticLoadBalancingV2::TrustStoreRevocation)
...
type TrustStoreRevocation struct {
	...
	// RevocationContents AWS CloudFormation Property
	// Required: false
...
func (r *TrustStoreRevocation) AWSCloudFormationType() string {
	return "AWS::ElasticLoadBalancingV2::TrustStoreRevocation"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r TrustStoreRevocation) MarshalJSON() ([]byte, error) {
	type Properties TrustStoreRevocation
...
func (r *TrustStoreRevocation) UnmarshalJSON(b []byte) error {
	type Properties TrustStoreRevocation
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = TrustStoreRevocation(*res.Properties)
	}
