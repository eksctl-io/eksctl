...
// StorageLensGroup AWS CloudFormation Resource (AWS::S3::StorageLensGroup)
...
func (r *StorageLensGroup) AWSCloudFormationType() string {
	return "AWS::S3::StorageLensGroup"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r StorageLensGroup) MarshalJSON() ([]byte, error) {
	type Properties StorageLensGroup
...
func (r *StorageLensGroup) UnmarshalJSON(b []byte) error {
	type Properties StorageLensGroup
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = StorageLensGroup(*res.Properties)
	}
