...
import (
	...
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/accessanalyzer"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/acmpca"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/amazonmq"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/amplify"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/amplifyuibuilder"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/apigateway"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/apigatewayv2"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/appconfig"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/appflow"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/appintegrations"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/applicationautoscaling"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/applicationinsights"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/appmesh"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/apprunner"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/appstream"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/appsync"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/aps"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ask"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/athena"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/auditmanager"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/autoscaling"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/autoscalingplans"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/backup"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/batch"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/budgets"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cassandra"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ce"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/certificatemanager"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/chatbot"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cloud9"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cloudformation"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cloudfront"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cloudtrail"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cloudwatch"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codeartifact"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codebuild"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codecommit"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codedeploy"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codeguruprofiler"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codegurureviewer"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codepipeline"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codestar"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codestarconnections"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/codestarnotifications"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cognito"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/config"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/connect"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/cur"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/customerprofiles"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/databrew"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/datapipeline"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/datasync"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/dax"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/detective"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/devopsguru"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/directoryservice"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/dlm"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/dms"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/docdb"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/dynamodb"
	...
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ecs"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/efs"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/eks"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/elasticache"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/elasticbeanstalk"
	...
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/elasticsearch"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/emr"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/emrcontainers"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/events"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/eventschemas"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/evidently"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/finspace"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/fis"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/fms"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/frauddetector"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/fsx"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/gamelift"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/globalaccelerator"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/glue"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/greengrass"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/greengrassv2"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/groundstation"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/guardduty"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/healthlake"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iam"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/imagebuilder"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/inspector"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iot"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iot1click"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iotanalytics"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iotcoredeviceadvisor"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iotevents"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iotfleethub"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iotsitewise"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iotthingsgraph"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/iotwireless"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ivs"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/kendra"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/kinesis"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/kinesisanalytics"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/kinesisanalyticsv2"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/kinesisfirehose"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/kms"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/lakeformation"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/lambda"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/licensemanager"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/lightsail"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/location"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/logs"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/lookoutequipment"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/lookoutmetrics"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/lookoutvision"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/macie"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/managedblockchain"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/mediaconnect"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/mediaconvert"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/medialive"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/mediapackage"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/mediastore"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/memorydb"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/msk"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/mwaa"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/neptune"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/networkfirewall"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/networkmanager"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/nimblestudio"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/opensearchservice"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/opsworks"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/opsworkscm"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/panorama"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/pinpoint"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/pinpointemail"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/qldb"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/quicksight"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ram"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/rds"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/redshift"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/refactorspaces"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/rekognition"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/resiliencehub"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/resourcegroups"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/robomaker"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/route53"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/route53recoverycontrol"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/route53recoveryreadiness"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/route53resolver"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/rum"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/s3"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/s3objectlambda"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/s3outposts"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/sagemaker"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/sdb"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/secretsmanager"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/securityhub"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/serverless"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/servicecatalog"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/servicecatalogappregistry"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/servicediscovery"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ses"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/signer"
	...
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ssm"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ssmcontacts"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/ssmincidents"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/sso"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/stepfunctions"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/synthetics"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/timestream"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/transfer"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/waf"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/wafregional"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/wafv2"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/wisdom"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/workspaces"
	"github.com/weaveworks/eksctl/pkg/goformation/cloudformation/xray"
)
