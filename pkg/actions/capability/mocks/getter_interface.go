...
func (_m *GetterInterface) Get(ctx context.Context, capabilityName string) ([]capability.Summary, error) {
	...
	var r0 []capability.Summary
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) ([]capability.Summary, error)); ok {
		return rf(ctx, capabilityName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) []capability.Summary); ok {
		r0 = rf(ctx, capabilityName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]capability.Summary)
		}
	}
