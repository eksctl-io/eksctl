...
type VerifiedAccessInstance struct {
	...
	CidrEndpointsCustomSubDomain *types.Value `json:"CidrEndpointsCustomSubDomain,omitempty"`
	...
	FipsEnabled *types.Value `json:"FipsEnabled,omitempty"`
	...
	VerifiedAccessTrustProviderIds *types.Value `json:"VerifiedAccessTrustProviderIds,omitempty"`
