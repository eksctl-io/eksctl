...
// SnapshotBlockPublicAccess AWS CloudFormation Resource (AWS::EC2::SnapshotBlockPublicAccess)
...
func (r *SnapshotBlockPublicAccess) AWSCloudFormationType() string {
	return "AWS::EC2::SnapshotBlockPublicAccess"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r SnapshotBlockPublicAccess) MarshalJSON() ([]byte, error) {
	type Properties SnapshotBlockPublicAccess
...
func (r *SnapshotBlockPublicAccess) UnmarshalJSON(b []byte) error {
	type Properties SnapshotBlockPublicAccess
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = SnapshotBlockPublicAccess(*res.Properties)
	}
