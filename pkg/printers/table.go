...
func (t *TablePrinter) PrintObj(obj any, writer io.Writer) error {
	return t.PrintObjWithKind("objects", obj, writer)
}

// PrintObjWithKind will print the passed object formatted as textual
// table to the supplied writer.
func (t *TablePrinter) PrintObjWithKind(kind string, obj any, writer io.Writer) error {
...
// the logger.
func (t *TablePrinter) LogObj(log logger.LoggerFunc, msgFmt string, obj any) error {
	b := &bytes.Buffer{}
...
func (t *TablePrinter) AddColumn(name string, getter any) {
