...
// RecordSetGroup_Coordinates AWS CloudFormation Resource (AWS::Route53::RecordSetGroup.Coordinates)
...
func (r *RecordSetGroup_Coordinates) AWSCloudFormationType() string {
	return "AWS::Route53::RecordSetGroup.Coordinates"
}
