...
// StorageLensGroup_MatchObjectAge AWS CloudFormation Resource (AWS::S3::StorageLensGroup.MatchObjectAge)
...
type StorageLensGroup_MatchObjectAge struct {
	...
	DaysGreaterThan *types.Value `json:"DaysGreaterThan,omitempty"`
	...
	DaysLessThan *types.Value `json:"DaysLessThan,omitempty"`
...
func (r *StorageLensGroup_MatchObjectAge) AWSCloudFormationType() string {
	return "AWS::S3::StorageLensGroup.MatchObjectAge"
}
