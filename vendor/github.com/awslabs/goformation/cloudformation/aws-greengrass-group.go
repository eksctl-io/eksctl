...
func (t *Template) GetAllAWSGreengrassGroupResources() map[string]AWSGreengrassGroup {
	results := map[string]AWSGreengrassGroup{}
	for name, untyped := range t.Resources {
		switch resource := untyped.(type) {
		case AWSGreengrassGroup:
		...
		case map[string]interface{}:
			...
			if resType, ok := resource["Type"]; ok {
				if resType == "AWS::Greengrass::Group" {
					// The resource is correct, unmarshal it into the results
					if b, err := json.Marshal(resource); err == nil {
						result := &AWSGreengrassGroup{}
...
func (t *Template) GetAWSGreengrassGroupWithName(name string) (AWSGreengrassGroup, error) {
	...
	return AWSGreengrassGroup{}, errors.New("resource not found")
}
