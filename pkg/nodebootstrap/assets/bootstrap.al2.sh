...
//TODO: Ideally this script should not call & depends on the AWS API's
//however it is the only way at the moment to obtain the instanceLifecycle value (Spot/on-demand)
//TODO: This assumes the instance already has a role/credentials (as it should when connecting)
