...
func (in *ClusterVPC) DeepCopyInto(out *ClusterVPC) {
	*out = *in
	...
	if in.PodSubnets != nil {
		...
		*out = make(map[string]*CustomSubnets, len(*in))
		for key, val := range *in {
			var outVal *CustomSubnets
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
				*out = new(CustomSubnets)
				(*in).DeepCopyInto(*out)
			}
			(*out)[key] = outVal
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomSubnets) DeepCopyInto(out *CustomSubnets) {
	*out = *in
	if in.CIDR != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomSubnets.
func (in *CustomSubnets) DeepCopy() *CustomSubnets {
	if in == nil {
		return nil
	}
	out := new(CustomSubnets)
