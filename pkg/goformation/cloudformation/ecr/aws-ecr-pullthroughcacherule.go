...
type PullThroughCacheRule struct {
	...
	CredentialArn *types.Value `json:"CredentialArn,omitempty"`
	...
	UpstreamRegistry *types.Value `json:"UpstreamRegistry,omitempty"`
	...
	UpstreamRegistryUrl *types.Value `json:"UpstreamRegistryUrl,omitempty"`
