...
// sources:
// assets/10-eksctl.al2.conf (985B)
...
func _10EksctlAl2Conf() (*asset, error) {
	bytes, err := _10EksctlAl2ConfBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "10-eksctl.al2.conf", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bindata = map[string]func() (*asset, error){
	"10-eksctl.al2.conf":  _10EksctlAl2Conf,
...
var _bintree = &bintree{nil, map[string]*bintree{
	"10-eksctl.al2.conf": {_10EksctlAl2Conf, map[string]*bintree{}},
