...
func (_m *ASG) LaunchInstances(ctx context.Context, params *autoscaling.LaunchInstancesInput, optFns ...func(*autoscaling.Options)) (*autoscaling.LaunchInstancesOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// ASG_LaunchInstances_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'LaunchInstances'
type ASG_LaunchInstances_Call struct {
	*mock.Call
}

// LaunchInstances is a helper method to define mock.On call
//   - ctx context.Context
//   - params *autoscaling.LaunchInstancesInput
//   - optFns ...func(*autoscaling.Options)
func (_e *ASG_Expecter) LaunchInstances(ctx interface{}, params interface{}, optFns ...interface{}) *ASG_LaunchInstances_Call {
	return &ASG_LaunchInstances_Call{Call: _e.mock.On("LaunchInstances",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *ASG_LaunchInstances_Call) Run(run func(ctx context.Context, params *autoscaling.LaunchInstancesInput, optFns ...func(*autoscaling.Options))) *ASG_LaunchInstances_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*autoscaling.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*autoscaling.LaunchInstancesInput), variadicArgs...)
	})
	return _c
}

func (_c *ASG_LaunchInstances_Call) Return(_a0 *autoscaling.LaunchInstancesOutput, _a1 error) *ASG_LaunchInstances_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ASG_LaunchInstances_Call) RunAndReturn(run func(context.Context, *autoscaling.LaunchInstancesInput, ...func(*autoscaling.Options)) (*autoscaling.LaunchInstancesOutput, error)) *ASG_LaunchInstances_Call {
	_c.Call.Return(run)
	return _c
}
