...
type RepositoryCreationTemplate struct {
	...
	AppliedFor *types.Value `json:"AppliedFor,omitempty"`
	...
	CustomRoleArn *types.Value `json:"CustomRoleArn,omitempty"`
	...
	RepositoryPolicy *types.Value `json:"RepositoryPolicy,omitempty"`
