...
// Integration AWS CloudFormation Resource (AWS::RDS::Integration)
...
type Integration struct {
	...
	AdditionalEncryptionContext map[string]*types.Value `json:"AdditionalEncryptionContext,omitempty"`
	...
	DataFilter *types.Value `json:"DataFilter,omitempty"`
	...
	IntegrationName *types.Value `json:"IntegrationName,omitempty"`
