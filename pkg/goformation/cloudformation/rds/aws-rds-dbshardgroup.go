...
type DBShardGroup struct {
	...
	ComputeRedundancy *types.Value `json:"ComputeRedundancy,omitempty"`
	...
	DBShardGroupIdentifier *types.Value `json:"DBShardGroupIdentifier,omitempty"`
	...
	MaxACU *types.Value `json:"MaxACU"`
	...
	MinACU *types.Value `json:"MinACU,omitempty"`
