...
type InstanceConnectEndpoint struct {
	...
	PreserveClientIp *types.Value `json:"PreserveClientIp,omitempty"`
...
func (r *InstanceConnectEndpoint) AWSCloudFormationType() string {
	return "AWS::EC2::InstanceConnectEndpoint"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r InstanceConnectEndpoint) MarshalJSON() ([]byte, error) {
	type Properties InstanceConnectEndpoint
...
func (r *InstanceConnectEndpoint) UnmarshalJSON(b []byte) error {
	type Properties InstanceConnectEndpoint
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = InstanceConnectEndpoint(*res.Properties)
	}
