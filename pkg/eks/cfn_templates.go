...
func amazonEksNodegroupYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "amazon-eks-nodegroup.yaml", size: 11098, mode: os.FileMode(420), modTime: time.Unix(1531823615, 0)}
...
func amazonEksVpcSampleYaml() (*asset, error) {
	...
	info := bindataFileInfo{name: "amazon-eks-vpc-sample.yaml", size: 3808, mode: os.FileMode(420), modTime: time.Unix(1532074612, 0)}
