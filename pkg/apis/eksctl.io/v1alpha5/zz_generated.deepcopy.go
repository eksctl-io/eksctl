...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VpcNAT) DeepCopyInto(out *VpcNAT) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VpcNAT.
func (in *VpcNAT) DeepCopy() *VpcNAT {
	if in == nil {
		return nil
	}
	out := new(VpcNAT)
