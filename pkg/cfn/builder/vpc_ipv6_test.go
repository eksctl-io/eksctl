...
var _ = Describe("IPv6 VPC builder", func() {
	...
	It("creates the ipv6 VPC and its resources", func() {
		...
		privateDNSRouteA := builder.PrivateSubnetDNS64Ipv6RouteKey + azAFormatted
		...
		Expect(vpcTemplate.Resources[privateDNSRouteA].Properties).To(Equal(fakes.Properties{
			DestinationIpv6CidrBlock: builder.DNS64IPv6CIDR,
			NatGatewayID:             map[string]interface{}{"Ref": builder.NATGatewayKey},
			RouteTableID:             map[string]interface{}{"Ref": privateRouteTableA},
		}))

		privateDNSRouteB := builder.PrivateSubnetDNS64Ipv6RouteKey + azBFormatted
