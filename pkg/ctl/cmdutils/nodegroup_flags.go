...
func AddCommonCreateNodeGroupFlags(fs *pflag.FlagSet, cmd *Cmd, ng *api.NodeGroup) {
	...
	fs.StringVar(&ng.AMIFamily, "node-ami-family", api.DefaultNodeImageFamily, "Advanced use cases only. Use 'AmazonLinux2' (default) for the official AWS EKS AMIs (Amazon Linux 2), 'Ubuntu1804' for the official Canonical EKS AMIs (Ubuntu 18.04) or 'FlatcarStable' for the official Kinvolk AMIs for Flatcar Container Linux Stable.")
