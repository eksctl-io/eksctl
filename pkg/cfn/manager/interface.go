...
type StackManager interface {
	...
	NewTasksToDeleteOIDCProviderWithIAMServiceAccounts(ctx context.Context, newOIDCManager NewOIDCManager, newTasksToDeleteIAMServiceAccounts NewTasksToDeleteIAMServiceAccounts, cluster *ekstypes.Cluster, force bool) (*tasks.TaskTree, error)
