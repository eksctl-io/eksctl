...
func ImportInstanceRoleFromProfileARN(iamAPI awsapi.IAM, ng *api.NodeGroup, profileARN string) error {
	...
	output, err := iamAPI.GetInstanceProfile(context.TODO(), input)
	if err != nil {
