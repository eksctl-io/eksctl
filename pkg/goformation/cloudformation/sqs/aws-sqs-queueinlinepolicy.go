...
func (r *QueueInlinePolicy) AWSCloudFormationType() string {
	return "AWS::SQS::QueueInlinePolicy"
}

// MarshalJSON is a custom JSON marshalling hook that embeds this object into
// an AWS CloudFormation JSON resource's 'Properties' field and adds a 'Type'.
func (r QueueInlinePolicy) MarshalJSON() ([]byte, error) {
	type Properties QueueInlinePolicy
...
func (r *QueueInlinePolicy) UnmarshalJSON(b []byte) error {
	type Properties QueueInlinePolicy
	res := &struct {
		Type                string
		Properties          *Properties
	...
	if res.Properties != nil {
		*r = QueueInlinePolicy(*res.Properties)
	}
