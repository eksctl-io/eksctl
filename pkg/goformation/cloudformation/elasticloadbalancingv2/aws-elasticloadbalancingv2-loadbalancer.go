...
type LoadBalancer struct {
	...
	EnablePrefixForIpv6SourceNat *types.Value `json:"EnablePrefixForIpv6SourceNat,omitempty"`
	...
	EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic *types.Value `json:"EnforceSecurityGroupInboundRulesOnPrivateLinkTraffic,omitempty"`
