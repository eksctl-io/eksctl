...
func (_m *ELBV2) ModifyIpPools(ctx context.Context, params *elasticloadbalancingv2.ModifyIpPoolsInput, optFns ...func(*elasticloadbalancingv2.Options)) (*elasticloadbalancingv2.ModifyIpPoolsOutput, error) {
	_va := make([]interface{}, len(optFns))
	for _i := range optFns {
		_va[_i] = optFns[_i]
	}
...
// ELBV2_ModifyIpPools_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ModifyIpPools'
type ELBV2_ModifyIpPools_Call struct {
	*mock.Call
}

// ModifyIpPools is a helper method to define mock.On call
//   - ctx context.Context
//   - params *elasticloadbalancingv2.ModifyIpPoolsInput
//   - optFns ...func(*elasticloadbalancingv2.Options)
func (_e *ELBV2_Expecter) ModifyIpPools(ctx interface{}, params interface{}, optFns ...interface{}) *ELBV2_ModifyIpPools_Call {
	return &ELBV2_ModifyIpPools_Call{Call: _e.mock.On("ModifyIpPools",
		append([]interface{}{ctx, params}, optFns...)...)}
}

func (_c *ELBV2_ModifyIpPools_Call) Run(run func(ctx context.Context, params *elasticloadbalancingv2.ModifyIpPoolsInput, optFns ...func(*elasticloadbalancingv2.Options))) *ELBV2_ModifyIpPools_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]func(*elasticloadbalancingv2.Options), len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*elasticloadbalancingv2.ModifyIpPoolsInput), variadicArgs...)
	})
	return _c
}

func (_c *ELBV2_ModifyIpPools_Call) Return(_a0 *elasticloadbalancingv2.ModifyIpPoolsOutput, _a1 error) *ELBV2_ModifyIpPools_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ELBV2_ModifyIpPools_Call) RunAndReturn(run func(context.Context, *elasticloadbalancingv2.ModifyIpPoolsInput, ...func(*elasticloadbalancingv2.Options)) (*elasticloadbalancingv2.ModifyIpPoolsOutput, error)) *ELBV2_ModifyIpPools_Call {
	_c.Call.Return(run)
	return _c
}
